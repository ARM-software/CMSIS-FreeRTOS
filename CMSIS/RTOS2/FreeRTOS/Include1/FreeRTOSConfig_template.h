...
//  <i> Callback function vApplicationStackOverflowHook implementation is required when stack
//  checking is enabled. <i> Default: 0
...
//  <i> Callback function vApplicationDaemonTaskStartupHook implementation is required when deamon
//  task startup hook is enabled. <i> Default: 0
#define configUSE_DAEMON_TASK_STARTUP_HOOK 0

//  <q>Use malloc failed hook
//  <i> Enable callback function call when out of dynamic memory.
//  <i> Callback function vApplicationMallocFailedHook implementation is required when malloc failed
//  hook is enabled. <i> Default: 0
#define configUSE_MALLOC_FAILED_HOOK 0

//  <o>Queue registry size
//  <i> Define maximum number of queue objects registered for debug purposes.
//  <i> The queue registry is used by kernel aware debuggers to locate queue and semaphore
//  structures and display associated text names. <i> Default: 0
...
//  <i> Enable TrustZone when FreeRTOS runs on the Non-Secure side and calls functions from the
//  Secure side. <i> Default: 1
