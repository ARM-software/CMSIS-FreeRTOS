...
Each directory contains layer description (Target.clayer.yml), RTE configuration for the target device and configuration parameters for the FVP model. Each layer targets a specific device platform. The below table contains information about target platforms and how they map to the model executable.
